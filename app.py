...
hide_streamlit_style = """
            <style>
            /* Ховаємо меню справа (три крапки) і футер */
            #MainMenu {visibility: hidden;}
            footer {visibility: hidden;}
            
            /* 🚨 ВАЖЛИВО: Ми більше не ховаємо header повністю, 
               бо там живе стрілочка для відкриття меню! */
            
            /* Ховаємо лише кнопку Deploy і меню справа */
            [data-testid="stToolbar"] {visibility: hidden !important;} 
            
            /* Ховаємо кольорову смужку зверху */
            [data-testid="stDecoration"] {display: none;} 

            /* Ховаємо борсука і аватарку */
